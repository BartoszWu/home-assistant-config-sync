...
| Directory | Display name | Slug |
| --- | --- | --- |
| `export/` | `HA Config Sync — Export` | `ha_config_sync_export` |
| `import/` | `HA Config Sync — Import` | `ha_config_sync_import` |

Read source versions from `export/config.yaml` and `import/config.yaml`; verify installed versions in HA.
